...
export const translations = {
  ru: {
    ...
    contactsDescription: 'Свяжитесь с нами для сотрудничества, обратной связи или вопросов по инструментам Q354.'
  ...
  en: {
    ...
    contactsDescription: 'Get in touch with us for collaboration, feedback, or questions about Q354 tools.'
    },
};